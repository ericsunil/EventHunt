...
public class Nearby extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View row = inflater.inflate(R.layout.fragment_nearby, container, false);
        rv = (RecyclerView) row.findViewById(R.id.rv_nearby);
        ...
        mAdapter =new RVAdapter(getActivity(), filter.getNearbyEvents());
        rv.setAdapter(mAdapter);
        layout = (PullRefreshLayout) row.findViewById(R.id.refresh_nearby);
