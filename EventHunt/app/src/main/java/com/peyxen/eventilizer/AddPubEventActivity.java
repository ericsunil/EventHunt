 ...
 */
public class AddPubEventActivity extends ActionBarActivity implements DatePickerDialog.OnDateSetListener {

    private static final String TAG = "AddPubEventActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_pubevent);

        mToolbar = (Toolbar) findViewById(R.id.toolbar_actionbar_pub);
        mToolbar.setTitle("Create Public Events");
        setSupportActionBar(mToolbar);

        calender = (ImageView) findViewById(R.id.imgCalender);
        cardView = (CardView) findViewById(R.id.cv);
        title = (EditText) findViewById(R.id.title_pub);
        desc = (EditText) findViewById(R.id.desc_pub);
    ...
    public void createPublicEvent(View view) {
        addEvent();
