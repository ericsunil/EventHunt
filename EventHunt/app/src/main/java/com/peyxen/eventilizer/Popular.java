...
public class Popular extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View row = inflater.inflate(R.layout.fragment_popular, container, false);
        rv = (RecyclerView) row.findViewById(R.id.rv_popular);
        ...
        mAdapter =new RVAdapter(getActivity(), filter.getPopularEvents());
        rv.setAdapter(mAdapter);
        layout = (PullRefreshLayout) row.findViewById(R.id.refresh_popular);
